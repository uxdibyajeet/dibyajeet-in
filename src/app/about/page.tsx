        ...
        <section className="about-context span-12">
          <div className="about-text">
            ...
            <p className="text-base">
              ...
              clarity, function, and solving real user problems. With a
            ...
            <p className="text-base">
              ...
              experience has shown that users give the most valuable feedback
              when they can react to something tangible rather than abstract
              ideas. By grounding hypotheses in rapid, testable prototypes, I
              help teams move from assumptions to validated, business-aligned
